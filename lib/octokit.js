...
exports.downloadDirList = exports.downloadFile = void 0;
...
var REPO_OWNER = "rust-lang";
var REPO_NAME = "this-week-in-rust";
var octokit = new Octokit({
    auth: process.env.GITHUB_TOKEN,
    throttle: {
        onRateLimit: function (retryAfter, options) {
            console.warn("Request quota exhausted for request ".concat(options.method, " ").concat(options.url, ". Retrying after ").concat(retryAfter, " seconds."));
            return true;
        },
